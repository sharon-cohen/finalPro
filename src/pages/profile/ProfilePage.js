...
import { signOutUser , getUserItemByUID,toggleTypeUser } from '../../firebase/CommonQueries';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        <ProgressDialog visible={isProgress} title="Progress Dialog" message="Please, wait..." />
        <View style={styles.userInfoSection}>
          ...
          <View style={{ marginTop: 20 }}>
            <View style={{}}>
              <Text style={[styles.title, {}]}>שלום,{currentUser.user.name}</Text>
            </View>
          </View>
        </View>
        ...
        {realTimePersonalList != null && realTimePersonalList != 0 ? (
          <View style={styles.productSection}>
            <ListSection
              nameSection={'מוצרים שלי'}
              listItems={realTimePersonalList}
